...
// clxx/functions/retain_kernel.t.h

/** // doc: clxx/functions/retain_kernel.t.h {{{
 * \file clxx/functions/retain_kernel.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_RETAIN_KERNEL_T_H_INCLUDED
#define CLXX_FUNCTIONS_RETAIN_KERNEL_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_RETAIN_KERNEL_T_H_INCLUDED */
