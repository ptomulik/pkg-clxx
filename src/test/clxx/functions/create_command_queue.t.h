...
/** // doc: clxx/functions/create_command_queue.t.h {{{
 * \file clxx/functions/create_command_queue.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_CREATE_COMMAND_QUEUE_T_H_INCLUDED
#define CLXX_FUNCTIONS_CREATE_COMMAND_QUEUE_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_CREATE_COMMAND_QUEUE_T_H_INCLUDED */
