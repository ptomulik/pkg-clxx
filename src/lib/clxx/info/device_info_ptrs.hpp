...
// clxx/info/device_info_ptrs.hpp

/** // doc: clxx/info/device_info_ptrs.hpp {{{
 * \file clxx/info/device_info_ptrs.hpp
 * \brief Defines \ref clxx::device_info_ptrs "device_info_ptrs"
 */ // }}}
#ifndef CLXX_INFO_DEVICE_INFO_PTRS_HPP_INCLUDED
#define CLXX_INFO_DEVICE_INFO_PTRS_HPP_INCLUDED

#include <clxx/info/device_info_ptr.hpp>
#include <vector>
...
#endif /* CLXX_INFO_DEVICE_INFO_PTRS_HPP_INCLUDED */
