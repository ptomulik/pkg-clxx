...
/** // doc: clxx/cl/mem_fcn.hpp {{{
 * \file clxx/cl/mem_fcn.hpp
 * \brief Declares mem object functions
 */ // }}}
#ifndef CLXX_CL_MEM_FCN_HPP_INCLUDED
#define CLXX_CL_MEM_FCN_HPP_INCLUDED
...
#endif /* CLXX_CL_MEM_FCN_HPP_INCLUDED */
