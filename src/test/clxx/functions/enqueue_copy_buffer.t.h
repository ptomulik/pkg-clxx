...
// clxx/functions/enqueue_copy_buffer.t.h

/** // doc: clxx/functions/enqueue_copy_buffer.t.h {{{
 * \file clxx/functions/enqueue_copy_buffer.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_ENQUEUE_COPY_BUFFER_T_H_INCLUDED
#define CLXX_FUNCTIONS_ENQUEUE_COPY_BUFFER_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_ENQUEUE_COPY_BUFFER_T_H_INCLUDED */
