...
// clxx/cl/functions/enqueue_read_buffer.t.h

/** // doc: clxx/cl/functions/enqueue_read_buffer.t.h {{{
 * \file clxx/cl/functions/enqueue_read_buffer.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_CL_FUNCTIONS_ENQUEUE_READ_BUFFER_T_H_INCLUDED
#define CLXX_CL_FUNCTIONS_ENQUEUE_READ_BUFFER_T_H_INCLUDED
...
namespace clxx { class functions_enqueue_read_buffer_test_suite; }

/** // doc: class clxx::functions_enqueue_read_buffer_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::functions_enqueue_read_buffer_test_suite : public CxxTest::TestSuite
{
public:
  ////////////////////////////////////////////////////////////////////////////
  //  enqueue_read_buffer()
...
#endif /* CLXX_CL_FUNCTIONS_ENQUEUE_READ_BUFFER_T_H_INCLUDED */
