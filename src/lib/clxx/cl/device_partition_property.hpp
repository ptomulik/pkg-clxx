...
// clxx/cl/device_partition_property.hpp

/** // doc: clxx/cl/device_partition_property.hpp {{{
 * \file clxx/cl/device_partition_property.hpp
...
#endif /* CLXX_CL_DEVICE_PARTITION_PROPERTY_HPP_INCLUDED */
