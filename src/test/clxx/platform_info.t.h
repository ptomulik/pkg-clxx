...
/** // doc: clxx/platform_info.t.h {{{
 * \file clxx/platform_info.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_PLATFORM_INFO_T_H_INCLUDED
#define CLXX_PLATFORM_INFO_T_H_INCLUDED
...
#endif /* CLXX_PLATFORM_INFO_T_H_INCLUDED */
