...
/** // doc: clxx/s11n/s11n2.cpp {{{
 * \file clxx/s11n/s11n2.cpp
 * \brief Usage example for \ref clxx_s11n
 */ // }}}
/** // doc: s11n/s11n2.cpp {{{
 * \example clxx/s11n/s11n2.cpp
 * \brief Usage example for \ref clxx_s11n -- read clxx::platform_layer_info
 *        from an XML archive and print it to std::cout
 */ // }}}
