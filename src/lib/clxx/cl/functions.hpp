...
// clxx/cl/functions.hpp

/** // doc: clxx/cl/functions.hpp {{{
 * \file clxx/cl/functions.hpp
 * \brief Bare C++ wrappers around OpenCL functions.
 */ // }}}
#ifndef CLXX_CL_FUNCTIONS_HPP_INCLUDED
#define CLXX_CL_FUNCTIONS_HPP_INCLUDED
...
#endif /* CLXX_CL_FUNCTIONS_HPP_INCLUDED */
