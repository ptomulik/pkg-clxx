...
/** // doc: clxx/device_info.t.h {{{
 * \file clxx/device_info.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_DEVICE_INFO_T_H_INCLUDED
#define CLXX_DEVICE_INFO_T_H_INCLUDED
...
#endif /* CLXX_DEVICE_INFO_T_H_INCLUDED */
