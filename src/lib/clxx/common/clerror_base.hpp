...
// clxx/common/clerror_base.hpp

/** // doc: clxx/common/clerror_base.hpp {{{
 * \file clxx/common/clerror_base.hpp
 * \brief Provides the clxx::clerror_base template class.
 */ // }}}
#ifndef CLXX_COMMON_CLERROR_NO_BASE_HPP_INCLUDED
#define CLXX_COMMON_CLERROR_NO_BASE_HPP_INCLUDED
...
#endif /* CLXX_COMMON_CLERROR_NO_BASE_HPP_INCLUDED */
