...
// clxx/common/clerror.hpp

/** // doc: clxx/common/clerror.hpp {{{
 * \file clxx/common/clerror.hpp
 * \brief Provides clxx::clerror class.
 */ // }}}
#ifndef CLXX_COMMON_CLERROR_HPP_INCLUDED
#define CLXX_COMMON_CLERROR_HPP_INCLUDED
...
#endif /* CLXX_COMMON_CLERROR_HPP_INCLUDED */
