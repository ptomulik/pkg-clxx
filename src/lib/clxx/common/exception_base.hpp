...
// clxx/common/exception_base.hpp

/** // doc: clxx/common/exception_base.hpp {{{
 * \file clxx/common/exception_base.hpp
 * \brief Defines the \ref clxx::exception_base "exception_base" template
 */ // }}}
#ifndef CLXX_COMMON_EXCEPTION_BASE_HPP_INCLUDED
...
#endif /* CLXX_COMMON_EXCEPTION_BASE_HPP_INCLUDED */
