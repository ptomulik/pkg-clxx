...
/** // doc: clxx/functions/create_context_from_type.t.h {{{
 * \file clxx/functions/create_context_from_type.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_CREATE_CONTEXT_FROM_TYPE_T_H_INCLUDED
#define CLXX_FUNCTIONS_CREATE_CONTEXT_FROM_TYPE_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_CREATE_CONTEXT_FROM_TYPE_T_H_INCLUDED */
