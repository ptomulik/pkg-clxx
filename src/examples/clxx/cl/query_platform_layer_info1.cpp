...
/** // doc: clxx/cl/query_platform_layer_info1.cpp {{{
 * \file clxx/cl/query_platform_layer_info1.cpp
 * \brief Usage example for \ref clxx::query_platform_layer_info() "query_platform_layer_info()"
 */ // }}}
/** // doc: cl/query_platform_layer_info1.cpp {{{
 * \example clxx/cl/query_platform_layer_info1.cpp
 * \brief Usage example for \ref clxx::query_platform_layer_info() "query_platform_layer_info()"
 */ // }}}
// [Program]
