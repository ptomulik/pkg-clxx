...
// clxx/common/ndrange.hpp

/** // doc: clxx/common/ndrange.hpp {{{
 * \file clxx/common/ndrange.hpp
 * \brief Defines the \ref clxx::ndrange class
 */ // }}}
#ifndef CLXX_COMMON_NDRANGE_HPP_INCLUDED
...
/* ------------------------------------------------------------------------ */
inline std::vector<size_t> ndrange::
global_offset() const
{
  if(!has_global_offset())
    throw uninitialized_value_error();
...
#endif /* CLXX_COMMON_NDRANGE_HPP_INCLUDED */
