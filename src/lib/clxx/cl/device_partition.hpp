...
// clxx/cl/device_partition.hpp

/** // doc: clxx/cl/device_partition.hpp {{{
 * \file clxx/cl/device_partition.hpp
 * \brief Declares clxx API for \ref clxx::device "device" partitioning
 */ // }}}
#ifndef CLXX_CL_DEVICE_PARTITION_HPP_INCLUDED
#define CLXX_CL_DEVICE_PARTITION_HPP_INCLUDED
