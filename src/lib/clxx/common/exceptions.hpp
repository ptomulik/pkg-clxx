...
// clxx/common/exceptions.hpp

/** // doc: clxx/common/exceptions.hpp {{{
 * \file clxx/common/exceptions.hpp
 * \brief Defines several exceptions used across clxx project
 */ // }}}
#ifndef CLXX_COMMON_EXCEPTIONS_HPP_INCLUDED
#define CLXX_COMMON_EXCEPTIONS_HPP_INCLUDED
...
#endif /* CLXX_COMMON_EXCEPTIONS_HPP_INCLUDED */
