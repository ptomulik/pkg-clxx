...
/** // doc: clxx/info/platform_query.t.h {{{
 * \file clxx/info/platform_query.t.h
 * \brief Unit tests for clxx::platform_query
 */ // }}}
#ifndef CLXX_INFO_PLATFORM_QUERY_T_H_INCLUDED
#define CLXX_INFO_PLATFORM_QUERY_T_H_INCLUDED
...
#endif /* CLXX_INFO_PLATFORM_QUERY_T_H_INCLUDED */
