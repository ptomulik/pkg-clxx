...
// clxx/functions/get_platform_ids.t.h

/** // doc: clxx/functions/get_platform_ids.t.h {{{
 * \file clxx/functions/get_platform_ids.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_GET_PLATFORM_IDS_T_H_INCLUDED
#define CLXX_FUNCTIONS_GET_PLATFORM_IDS_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_GET_PLATFORM_IDS_T_H_INCLUDED */
