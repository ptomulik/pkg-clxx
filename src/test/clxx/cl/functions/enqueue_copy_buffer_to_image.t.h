...
// clxx/cl/functions/enqueue_copy_buffer_to_image.t.h

/** // doc: clxx/cl/functions/enqueue_copy_buffer_to_image.t.h {{{
 * \file clxx/cl/functions/enqueue_copy_buffer_to_image.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_CL_FUNCTIONS_ENQUEUE_COPY_BUFFER_TO_IMAGE_T_H_INCLUDED
#define CLXX_CL_FUNCTIONS_ENQUEUE_COPY_BUFFER_TO_IMAGE_T_H_INCLUDED
...
#endif /* CLXX_CL_FUNCTIONS_ENQUEUE_COPY_BUFFER_TO_IMAGE_T_H_INCLUDED */
