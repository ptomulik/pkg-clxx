...
// clxx/functions/get_image_info.t.h

/** // doc: clxx/functions/get_image_info.t.h {{{
 * \file clxx/functions/get_image_info.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_GET_IMAGE_INFO_T_H_INCLUDED
#define CLXX_FUNCTIONS_GET_IMAGE_INFO_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_GET_IMAGE_INFO_T_H_INCLUDED */
