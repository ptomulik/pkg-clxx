...
// clxx/functions/enqueue_migrate_mem_objects.t.h

/** // doc: clxx/functions/enqueue_migrate_mem_objects.t.h {{{
 * \file clxx/functions/enqueue_migrate_mem_objects.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_FUNCTIONS_ENQUEUE_MIGRATE_MEM_OBJECTS_T_H_INCLUDED
#define CLXX_FUNCTIONS_ENQUEUE_MIGRATE_MEM_OBJECTS_T_H_INCLUDED
...
#endif /* CLXX_FUNCTIONS_ENQUEUE_MIGRATE_MEM_OBJECTS_T_H_INCLUDED */
