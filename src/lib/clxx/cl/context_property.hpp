...
// clxx/cl/context_property.hpp

/** // doc: clxx/cl/context_property.hpp {{{
 * \file clxx/cl/context_property.hpp
...
struct context_property
{
   ...
   * context_properties_t::platform and \ref value() to **p.get()**.
   *
  ...
  context_property(platform const& p) noexcept
    : _name(context_properties_t::platform), _value((cl_context_properties)p.get())
  {}
  /** // doc: name() const {{{
...
#endif /* CLXX_CL_CONTEXT_PROPERTY_HPP_INCLUDED */
