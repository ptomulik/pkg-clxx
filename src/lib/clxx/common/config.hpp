...
// clxx/common/config.hpp

/** // doc: clxx/common/config.hpp {{{
 * \file clxx/common/config.hpp
 * \brief Configuration and preprocessor macros used across clxx project
 */ // }}}
#ifndef CLXX_COMMON_CONFIG_HPP_INCLUDED
#define CLXX_COMMON_CONFIG_HPP_INCLUDED
